  ...
  return (
    <>
      ...
      <div className="w-full bg-[#FAB702] px-64 py-2 flex items-center justify-between xs:p-2 xs:gap-3 sm:px-4 md:px-6 lg:px-8">
        <p className="text-[#FFFFFF] text-md font-bold xs:text-[14px] sm:text-[12px]">
        ...
        <button className="bg-[#FFFFFF] py-2 px-6 text-[#252C3A] font-bold xs:text-[12px] sm:text-[12px] sm:p-3 xs:p-2">Get A Quote</button>
      </div>
    </>
  );
}
